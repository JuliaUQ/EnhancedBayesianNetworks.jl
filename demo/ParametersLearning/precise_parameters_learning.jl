...
G[:R=>:yesR, :S=>:offS, :G=>:wetG] = 0.90
G[:R=>:yesR, :S=>:offS, :G=>:dryG] = 0.10
G[:R=>:noR, :S=>:onS, :G=>:wetG] = 0.90
G[:R=>:noR, :S=>:onS, :G=>:dryG] = 0.10
G[:R=>:noR, :S=>:offS, :G=>:wetG] = 0.00
G[:R=>:noR, :S=>:offS, :G=>:dryG] = 1.00
